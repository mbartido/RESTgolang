...
func (o *UserListAPI) initHandlerCache() {
	...
	o.handlers["POST"]["/user"] = users.NewAddOne(o.context, o.UsersAddOneHandler)

	if o.handlers["DELETE"] == nil {
		o.handlers["DELETE"] = make(map[string]http.Handler)
	}
	o.handlers["DELETE"]["/user/{id}"] = users.NewDestroyOne(o.context, o.UsersDestroyOneHandler)

	if o.handlers["GET"] == nil {
		o.handlers["GET"] = make(map[string]http.Handler)
	}
	o.handlers["GET"]["/user"] = users.NewFindUsers(o.context, o.UsersFindUsersHandler)
	...
	o.handlers["PATCH"]["/user/{id}"] = users.NewUpdateOne(o.context, o.UsersUpdateOneHandler)
